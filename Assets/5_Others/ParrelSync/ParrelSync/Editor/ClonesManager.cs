...
namespace ParrelSync
{
    ...
    public class ClonesManager
    {
        ...
        public static Project CreateCloneFromPath(string sourceProjectPath)
        {
            ...
            Debug.Log("*** assetPath  sourceProject = " + sourceProject.assetPath); 
            Debug.Log("*** assetPath  cloneProject = " + cloneProject.assetPath);
            //Link Folders
        ...
        private static void CreateLinkMac(string sourcePath, string destinationPath)
        {
            ...
            Debug.Log("*** assetPath AFTER sourceProject = " + sourcePath);
            Debug.Log("*** assetPath AFTER cloneProject = " + destinationPath);
        ...
        private static void ExecuteBashCommand(string command)
        {
            ...
            Debug.Log("*** Final command = " + command);
