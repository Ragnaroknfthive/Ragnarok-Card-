...
public class PVPManager : MonoBehaviour
{
    ...
    public float p1DamageCapacityReducedby = 0, p2DamageCapacityReducedby = 0, p1StaminRecoveryReducedBy = 0, p2StaminaRecovertReducedby = 0, p1DamageIncreasedby = 0, p2DamageIncreasedby = 0, p1SpeedSlowBy = 0, opponentAttackWeakPercentageVal=0;
      ...
      Chessman pObj = opponentObj;
        switch(location)
        {
            ...
            case ((int)AttackLocation.Middle):
                ...
                my_opponentStaminaLessRecovertPerncetage += (isAttackedInMiddleOpponent * 0.05f);
    ...
    public void RPC_otherplayerTurnPoker(Player _player)
    {
        ...
        else
        {
           ...
           // {
            ...
            PokerButtonManager.instance.bet_attack.interactable = Game.Get().BetAmount  <= P1RemainingHandHealth ? true : false;
            ...
            PokerButtonManager.instance.call_Engauge.interactable = Game.Get().BetAmount <= P1RemainingHandHealth ? true : false;
            ...
            if(Game.Get().turn >= 2)
            {
               // PokerButtonManager.instance.check_Defend_5_Stamin.gameObject.SetActive(true);
                ...
                if((Game.Get().turn == 2 || Game.Get().turn == 4 || Game.Get().turn == 6 || Game.Get().turn == 8) && Game.Get().lastAction== PlayerAction.engage)
                {
            ...
            //All In
            if(P2LastAttackValue * 2 > P1RemainingHandHealth) // if(Game.Get().BetAmount * 2 > P1RemainingHandHealth)
            {
                PokerButtonManager.instance.Reraise_CouterAttack.gameObject.SetActive(false);
            ...
            if(!isAttackLocationSelected || !isDefenceLocationSelected)
            {
                LocationChoices.SetActive(true);
    ...
    private void ChekcForWeaknessFactor()
    {
        ...
        //Location Effect
        int extraDamageForHighLimbAttack = (int)(((isAttackedHigh * 0.05f) + p1DamageIncreasedby) * AttackFor);
        ...
        if(myCharWeakAgainst == opponent)
        {
            ...
            UpdateRemainingHandHealthPlus(total);
        ...
        {
            UpdateRemainingHandHealthPlus((+player2weakEffectFactor - extraDamageForHighLimbAttack));
        }
    }
    ...
    private void ManangeAttackLocationEffects()
    {
        ...
        switch (opponentAttackLocation)
        {
            ...
            case AttackLocation.Middle:
                p1StaminRecoveryReducedBy += (isAttackedInMiddle * 0.05f);
                Debug.Log("Damage Capacity Reduced by ___" + " %---" + (p1StaminRecoveryReducedBy * 100));
                //Reduce damage capacity by 5%  
    ...
    {
        //StartCoroutine(CheckWinNew(true,3f));
    }
    ...
    public void ConfirmChoice() 
    {
        if (tempChoiceNo != -1)
        {
            int c = -1;
            c = tempChoiceNo;
            Debug.Log("TEMP CHOICE " + tempChoiceNo);
    ...
    public void UpdateRangePoints(int c)
    {
        ...
        //{
            ...
            {
                P1RageBar.value += 10;
                P1RageTxt.text =((int)P1RageBar.value).ToString();
                rangeCounter = 0;
    ...
    public void OnClickEndTurn()
    {
        ...
        if(Game.Get().lastAction == PlayerAction.attack || Game.Get().lastAction == PlayerAction.counterAttack)
        {
            ...
            {
                p1AttackFor.text = (Game.Get().lastAction == PlayerAction.counterAttack) ? "Counter attack for " + (int)attackSlider._slider.value
                    : "Attack For " + (int)attackSlider._slider.value;
                photonView.RPC("UpdateAttackForText",RpcTarget.Others,(int)attackSlider._slider.value,Game.Get().lastAction == PlayerAction.counterAttack,false);
                p1AttackFor.gameObject.transform.parent.GetComponent<RectTransform>().LeanScale(Vector3.one,0.3f);
            }
        ...
        if(isAllIn)
        {
           ...
           // photonView.RPC("DisplayOpponentCard_RPC",RpcTarget.All); 
            ...
            if(!isFromInbetween)
            {
                ...
                p1AttackFor.gameObject.transform.parent.GetComponent<RectTransform>().LeanScale(Vector3.one,0.3f);
                photonView.RPC("UpdateAttackForText",RpcTarget.Others,(int)attackSlider._slider.value,false,true);
                //  if(!Game.Get().IsDefender)
                //   {
                // photonView.RPC("UpdatePotAmountForText",RpcTarget.All,(int)attackSlider._slider.value);
    ...
    public void UpdateRangePoint(int ragePoints)
    {
        if(rangeCounter >= 3)
        {
            ...
            P1RageTxt.text = P1RageBar.value.ToString();
    ...
    public void UpdateRagePoints_RPC(int ragePoints)
    {
            ...
            P2RageTxt.text = ragePoints.ToString();
    }
    [PunRPC]
...
#region oldCode
    ...
    public IEnumerator CheckWin(){
        ...
        if(P1HealthBar.value <= 0){
            ...
            //if(isattackerMaster)
                ...
                p2Obj.pData.stamina = (int)P2StaBar.value;
            // else
            ...
            //if(isattackerMaster)
                ...
                p1Obj.pData.stamina = (int)P1StaBar.value;
            // else
    ...
    public void SetDataRPC(Vector2 posP1, Vector2 posP2,bool isReverse){
        ...
        p1Speed = myObj.pData.speed;
        p2Speed = opponentObj.pData.speed;
        ...
        isAttackedHigh = (int)myObj.high;
        isAttackedLow = (int)myObj.low;
        isAttackedOnRightSide = (int)myObj.right;
        isAttackedOnLeftSide = (int)myObj.left;
        isAttackedInMiddle = (int)myObj.medle;

        isAttackedHighOpponent = (int)opponentObj.high;
        isAttackedLowOpponent = (int)opponentObj.low;
        isAttackedOnRightSideOpponent = (int)opponentObj.right;
        isAttackedOnLeftSideOpponent = (int)opponentObj.left;
        isAttackedInMiddle = (int)opponentObj.medle;

        myExtraDamagePercentage = isAttackedHighOpponent * 0.05f;
        my_opponentAttackMadeWeakerPerntage = Mathf.Max(isAttackedOnLeftSideOpponent, isAttackedOnRightSideOpponent) * 0.05f;
        my_OpponetSpeedMakeSlowerPercentage = isAttackedLowOpponent * 0.05f;
        my_opponentStaminaLessRecovertPerncetage = isAttackedInMiddleOpponent * 0.05f;
       ...
       // UpdateSpeed();
        ...
        {
            p2Image.sprite = p1Char.ChracterSp;
        ...
        else
        {
            ...
            p2Image.sprite = p2Char.ChracterSp;
        }
    ...
    {
        P2RageTxt.text =(( int) P2RageBar.value).ToString();//+ "/" + P1HealthBar.maxValue;
    }
